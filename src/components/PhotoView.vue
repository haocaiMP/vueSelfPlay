<template>
  <div class="photoViewMask" v-if="showViewer" @click="closePhotoViewer">
    ...
    <img :src="data[currentIndex - 1]" alt="" v-show="show" class="img" ref="img" @click.stop="preventEvent">
    </transition>
  ...
  export default {
    props: {
      ...
      data: {
        type: Array,
        default: () => [
        'https://gw.alicdn.com/tfs/TB1oRxprntYBeNjy1XdXXXXyVXa-164-208.png',
        'https://gw.alicdn.com/tfs/TB1lRxprntYBeNjy1XdXXXXyVXa-164-208.png',
        'https://gw.alicdn.com/tfs/TB1C8bFq1uSBuNjy1XcXXcYjFXa-164-208.png',
        'https://gw.alicdn.com/tfs/TB1CBbFq1uSBuNjy1XcXXcYjFXa-164-208.png'
        ]
      },
      value: {
        type: Boolean,
